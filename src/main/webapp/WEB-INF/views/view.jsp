		...
		<table width="690" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<%-- <img src="../../img/btn_list.gif" 
					...
					<img src="../../img/btn_modify.gif" onClick='location.href="/update/${vo.idx}"' style="cursor:pointer"> 
					<img src='../../img/btn_delete.gif' onClick='del();' style='cursor: pointer'>
					<img src='../../img/btn_back.gif' onClick='location.href="/list"' style="cursor:pointer"></td>
			</tr>
		</table>
	</form>          	   
</body>
